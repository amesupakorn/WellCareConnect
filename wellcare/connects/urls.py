...
urlpatterns = [
    ...
    path("book-first/check-available-times/", views.CheckAvailableTimes.as_view(), name="check-available-times"),
    ...
    path("book-third/<int:id>/confirm/", views.ConfirmBooking.as_view(), name="book-confirm"),
